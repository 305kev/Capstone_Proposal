...
def get_graph_recommendations(title, fitted_graph):
    """
    :param title: string, the case title and date
    :param graph_dictionary: GraphRecommendations object, a fitted
    graph with communities where cases are nodes, and edges are
    weighted by number of shared citations
    :return: list, of recommended cases
    """
    search_query = title
    community_value = fitted_graph.parts[search_query]
